...
function sequence_frame(){
  ...
  var M_14_2 = document.getElementsByClassName("M_14_2");
  var M_14_3 = document.getElementsByClassName("M_14_3");
  ...
  for(var i = 0; i < M_14_2.length; i++){
    M_14_2[i].style.backgroundPositionX= (count_animation * 32).toString() + "px";
  }
  for(var i = 0; i < M_14_3.length; i++){
    M_14_3[i].style.backgroundPositionX= (count_animation * 32).toString() + "px";
  }
  count_animation++;
}
//左边栏信息刷新
function refresh(){
  ...
  var Money = $("Money");
  Money.innerHTML = obj_hero.money.toString();

  var Floor = $("Floor");
  Floor.innerHTML = obj_hero.now_floor.toString();
}
